...
function canConnect(source, target) {
  ...
  // new connections for uml elements
  // if (is(source, 'od:Circle') || is(target, 'od:Decision')) {
  //   return { type: 'od:Link' };
  // }
...
function canResize(shape, newBounds) {
  if (isAny(shape, [ 'od:Object', 'od:Circle', 'od:Decision', 'od:Rectangle', 'od:Oval', 'od:Rhomboid' ])) {
