...
function canConnect(source, target) {
  ...
  // no connections of object with other uml elements
  if (is(source, 'od:Object') && (is(target, 'od:Circle'))) {
    return false;
  }

  if (is(source, 'od:Circle') && (is(target, 'od:Object'))) {
    return false;
  }
...
function canResize(shape, newBounds) {
  if (isAny(shape, [ 'od:Object', 'od:Circle', 'od:Decision', 'od:Rectangle', 'od:Oval', 'od:Parallelogram', 'od:Actor'])) {
